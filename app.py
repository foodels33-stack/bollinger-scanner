...
BOT_TOKEN = "8777322821:AAFi4SikdUit4WJ3vEAUbYhBU0dp1KrBsuw"
CHAT_ID = "6649894327"
...
def send_telegram(msg):
    try:
        ...
        if r.status_code != 200:
            st.error(f"Telegram {r.status_code}: {r.text}")
            return False
        return True
...
st.markdown('<div style="background:#15182A; padding:12px; border-radius:12px; color:white; font-weight:700">TradePulse PRO - BUY LOW FULL MONSTER - @omer_turbo72_bot</div>', unsafe_allow_html=True)
